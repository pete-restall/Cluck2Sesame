...
void test_doorOpenScheduleActioned_onPublishedWhenStateIsOpening_expectMotorIsNotTurnedOn(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Opening,
...
void test_doorOpenScheduleActioned_onPublishedWhenStateIsOpening_expectMotorCurrentLimitIsNotChanged(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Opening,
