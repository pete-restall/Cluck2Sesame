...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsOpening_expectSameStateWithCloseTransition(void)
{
...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsOpening_expectMotorIsNotEnabled(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Opening,
...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsOpening_expectMotorIsNotTurnedOn(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Opening,
...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsOpening_expectMotorCurrentLimitIsNotChanged(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Opening,
