...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsOpeningWaitingForEnabledMotor_expectSameStateWithCloseTransition(void)
{
...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsOpeningWaitingForEnabledMotor_expectMotorIsNotEnabled(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Opening_WaitingForEnabledMotor,
...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsOpeningWaitingForEnabledMotor_expectMotorIsNotTurnedOn(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Opening_WaitingForEnabledMotor,
...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsOpeningWaitingForEnabledMotor_expectMotorCurrentLimitIsNotChanged(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Opening_WaitingForEnabledMotor,
