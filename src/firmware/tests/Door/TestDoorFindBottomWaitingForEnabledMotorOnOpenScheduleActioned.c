...
void test_doorOpenScheduleActioned_onPublishedWhenStateIsFindBottomWaitingForEnabledMotor_expectMotorIsNotEnabled(void)
{
...
void test_doorOpenScheduleActioned_onPublishedWhenStateIsFindBottomWaitingForEnabledMotor_expectMotorIsNotTurnedOn(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_FindBottom_WaitingForEnabledMotor,
...
void test_doorOpenScheduleActioned_onPublishedWhenStateIsFindBottomWaitingForEnabledMotor_expectMotorCurrentLimitIsNotChanged(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_FindBottom_WaitingForEnabledMotor,
