...
// TODO: WHEN STOPPED WITH > 3mm THEN EXPECT DOOR_CLOSED, CLOSED_STATE, ETC. (REVERSAL IF TRANSITION = OPEN, ETC. ETC.)

// TODO: WHEN STOPPED WITH NON-CURRENT LIMIT FAULT, EXPECT NO DOOR_ABORTED, FAULT_STATE, ETC.
