...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsFault_expectSameStateWithCloseTransition(void)
{
...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsFault_expectMotorIsNotEnabled(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Fault,
...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsFault_expectMotorIsNotTurnedOn(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Fault,
...
void test_doorCloseScheduleActioned_onPublishedWhenStateIsFault_expectMotorCurrentLimitIsNotChanged(void)
{
	struct DoorStateWithContext state =
	{
		.current = DoorState_Fault,
