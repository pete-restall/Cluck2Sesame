...
void doorInitialise(void)
{
	...
	// TODO: MotorEnabled - changes state to Opening or Closing if {Opening,Closing}_WaitingForEnabledMotor, and starts the motor turning; DOES *NOT* MODIFY THE TRANSITION, HOWEVER...
}
